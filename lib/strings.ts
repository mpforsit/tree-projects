...
export const strings = {
  ...
  glance: {
    ...
    emptyAdminHint: "Lege oben mit „+ Neu“ den ersten Bereich oder das erste Projekt an.",
  },
  create: {
    new: "+ Neu",
    firstNode: "+ Erstes Element anlegen",
    typeLabel: "Typ wählen",
    typeArea: "Bereich",
    typeProject: "Projekt",
    typeTask: "Aufgabe",
    titleArea: "Name des neuen Bereichs",
    titleProject: "Name des neuen Projekts",
    titleTask: "Titel der neuen Aufgabe",
    submit: "Anlegen",
  },
  status: {
    open: "offen",
